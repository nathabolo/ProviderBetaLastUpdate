...
public class MyFontOpenRegEditText extends EditText {

    private Typeface typeface;

    public MyFontOpenRegEditText(Context context) {
        super(context);
    }

    public MyFontOpenRegEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public MyFontOpenRegEditText(Context context, AttributeSet attrs, int defStyle) {
