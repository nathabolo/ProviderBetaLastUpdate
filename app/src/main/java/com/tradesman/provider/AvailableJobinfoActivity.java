...
public class AvailableJobinfoActivity extends ActionBarBaseActivity implements View.OnClickListener, AsyncTaskCompleteListener {
    ...
    public void CreateProvideBuyTokenDialog(String buyTokenMessage,  int tokenValue){
        ImageView imgClose;
        Button btnSubmit;
        buyTokensDialog = new Dialog(AvailableJobinfoActivity.this);
    ...
    public void CreateProvideQuoteDialog(){
        ...
        Button btnSubmit;
        provideQuoteDialog = new Dialog(AvailableJobinfoActivity.this);
...
//                String.valueOf(Html.fromHtml(activeJob.getCurrency())));
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AvailableJobinfoActivity.this);
                builder.setTitle("Send Quotation for Job Request");
                builder.setIcon(R.drawable.app_icon);
                builder.setMessage("You are about to Send a Quotation for the Job Request sent to you. You will charged 5 Tokens\n\n Are you sure you want to send the job Request?");
...
//
//        ProfileActivity.edtName.setText(preferenceHelper.getUserName());
